...
from work_summaries import render_home_links
...
<section class="wide real-estate-showcase" id="villa-lumiere-3d-walkthrough"><div class="real-estate-showcase__intro"><div><p class="section-label">REAL ESTATE / HOSPITALITY / 3D WALKTHROUGH</p><h2>不動産・ホテル・旅館の空間を伝える、3D内覧・館内PR動画。</h2></div><p>Blenderで制作した3D建築・室内PR動画の制作サンプルです。不動産・建築・宿泊施設の動画制作と、自社で作れるようになるレクチャーの両方を相談できます。</p></div><figure class="portfolio-video"><video controls playsinline preload="metadata" poster="/uploads/videos/villa-lumiere-3d-walkthrough-poster.jpg" width="1280" height="720" aria-describedby="villa-lumiere-home-caption"><source src="/uploads/videos/villa-lumiere-3d-walkthrough.mp4" type="video/mp4"><p>お使いのブラウザでは動画を再生できません。<a href="/works/villa-lumiere-3d-walkthrough.html">動画の詳細を見る</a></p></video><figcaption id="villa-lumiere-home-caption"><strong>制作サンプル：</strong>Blenderで制作した架空の邸宅「VILLA LUMIÈRE」の3D建築・室内PRウォークスルー。実在の販売物件ではありません。</figcaption></figure><div class="portfolio-video-links"><a class="btn btn-dark" href="/works/villa-lumiere-3d-walkthrough.html">制作サンプル・詳細を見る <span aria-hidden="true">→</span></a><a class="text-link" href="/services/real-estate-3d-video.html#hospitality">不動産・ホテル・旅館向け3D内覧動画の制作・レクチャーについて <span aria-hidden="true">↗</span></a></div></section>
...
<details><summary>不動産やホテル・旅館の3D内覧動画、Blenderのレクチャーも相談できますか？</summary><p>はい。物件紹介・建築PRに加え、ホテル・旅館の客室や館内を紹介する3Dカメラウォーク映像の制作と、自社で作れるようになるためのBlenderレクチャーを相談できます。まずは動画の用途、図面・室内写真などの資料、制作を依頼したい範囲か習得したい範囲かを伺います。</p><a class="text-link" href="/services/real-estate-3d-video.html#hospitality">不動産・ホテル・旅館向け3D内覧・館内PR動画について →</a></details>
</div></section>
...
person={'@type':'Person','@id':BASE+'/#person','name':'田口侑生','alternateName':'Yuki Taguchi','url':BASE+'/about.html','image':BASE+'/uploads/creator_avatar.png','jobTitle':'AIエンジニア・動画制作者','description':'岩手県を拠点にAI動画制作、業務自動化、Web・アプリ開発を行う。オンラインで全国対応。','sameAs':['https://github.com/yukitagushi'],'knowsAbout':['AIエージェント','AI広告動画制作','不動産向け3D内覧動画','ホテル・旅館向け3D館内紹介動画','Blenderによる建築CG','動画編集自動化','研修動画制作','動画マニュアル','業務自動化']}
