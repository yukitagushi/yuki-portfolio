...
def render_reel(videos=None):
    ...
    for index, item in enumerate(videos):
        ...
        duration = item.get('displayDuration', 8)
        slides.append(f'''<div class="reel-slide{' is-portrait' if height > width else ''}{' is-active' if first else ''}" data-mobile-layout="{layout}" data-display-duration="{duration:g}" style="--reel-media-ratio: {width} / {height}">
...
</div><script src="/assets/hero-reel.js?v=hero-duration-1" defer></script>''', True
