...
<div class="reel-caption"><div class="reel-work"><span class="reel-count" data-reel-count>01 / {len(videos):02}</span><a data-reel-link href="{esc(first['href'])}" aria-label="{esc(first['title'])}の全編を見る">{esc(first['title'])}<span aria-hidden="true"> ↗</span></a></div>
